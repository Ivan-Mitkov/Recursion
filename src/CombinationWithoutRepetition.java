...
public class CombinationWithoutRepetition {
	...
	public static void main(String[] args) {
		...
		CombinationMinusRepetition(arr, n, m);
	}
	...
	private static void CombinationWithoutRepetitionUtil(int chosen[], int arr[],
	                    int index, int r, int start, int end)
	{
	    ...
	    for (int i = start; i <= end; i++)
	    {
	    	...
	    	chosen[index] = i;
	    	CombinationWithoutRepetitionUtil(chosen, arr, index + 1,
                        r, i+1, end);
	...
	private static void CombinationMinusRepetition(int arr[], int n, int r)
	{
	    // Allocate memory
	    int chosen[]= new int[r+1];
	 
	    // Call the recursice function
	    CombinationWithoutRepetitionUtil(chosen, arr, 0, r, 0, n-1);
	}
